...
namespace FOIE
{
    internal class ControlMoverOrResizer
    {
        ...
        internal static void Init(Control control, Control txtPair)
        {
        ...
        private static void StartMovingOrResizing(Control control, MouseEventArgs e, Control txtPair)
        {
        ...
        //----------------------------------------------------------------
        private static void refreshText(Control control, Control txtPair)
        {
            int[] coords =
            {
                control.Location.X,
                control.Location.Y,
                control.Width + control.Location.X,
                control.Height + control.Location.Y
            };
            int x1 = control.Location.X;
            string b = control.Size.ToString();

            txtPair.Text = string.Join(" ", coords);
        }
